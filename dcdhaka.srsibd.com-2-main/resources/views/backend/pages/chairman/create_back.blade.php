                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Chairman Create Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="Form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 col-form-label">Chairman Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" placeholder="Bridge Name" class="form-control" id="name">
                                    </div>
                                </div>
                                <div class="form-group row">
