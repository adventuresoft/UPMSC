@extends('backend.master', ['mainMenu' => 'Vehicle', 'subMenu' =>'VehicleApprovalList'])
@push('style')
<style>
    .table-action {
        display: flex;
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-6 text-left">
                                    <h3 class="card-title" style="font-size:24px; font-weight: semi-bold;">Vehicle Approval List</h3>
                                </div>
