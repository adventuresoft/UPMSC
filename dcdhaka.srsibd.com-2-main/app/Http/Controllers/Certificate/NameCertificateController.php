...
class NameCertificateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $result = DB::transaction(function () use ($request) {
            ...
            $certificate->name_english = $request->name_english; // add this
    $certificate->name_bangla = $request->name_bangla;   // add this
    ...
    public function show($id)
    {
       $data['certificate'] = NameCertificate::with(array('user' => function($q1){
        ...
        return view('backend.pages.certificate.name.certificate', $data);
