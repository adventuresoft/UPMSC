...
Route::controller(RolePermissionController::class)->group(function () {
    ...
    Route::get('rolepermission/{id}/edit','edit')->name('rolepermission.edit');
    Route::patch('rolepermission/{id}','update')->name('rolepermission.update');
    Route::delete('rolepermission/delete','destroy')->name('rolepermission.destroy');
});
...
Route::controller(RoleUserController::class)->group(function () {
    ...
    Route::get('roleuser/{id}/edit','edit')->name('roleuser.edit');
...
Route::controller(UserPermissionController::class)->group(function () {
    ...
    Route::get('userper/{id}/edit','edit')->name('userper.edit');
    Route::patch('userper/{id}','update')->name('userper.update');
    Route::delete('userper/delete','destroy')->name('userper.destroy');
});
