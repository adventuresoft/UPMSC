...
class FamilyCertificateController extends Controller
{
    ...
    {
        $data['certificates'] = FamilyCertificate::with([
        ...
        ->latest()
        ->get();
        return view('backend.pages.certificate.family.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('backend.pages.certificate.family.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $result = DB::transaction(function () use ($request) {
            ...
            $certificate = new FamilyCertificate();
            ...
            try {
                ...
                $data['code'] = 200;
                $data['redirect_url'] = route('family.index');
                // $data['redirect_url'] = route('family.show', $certificate->id);
                return $data;
            } catch (\Throwable $th) {
                $data['status'] = false;
     ...
     *
     * @param  \App\Models\Certificate\FamilyCertificate  $familyCertificate
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        $data['certificate'] = FamilyCertificate::with(array('user' => function($q1){
        ...
        return view('backend.pages.certificate.family.certificate', $data);
        $html = view('backend.pages.certificate.family.certificate', $data)->render();
        ...
        return $pdf->stream('family-certificate.pdf');
    ...
    public function bn_certificate($id){
        ...
        // return response()->json($data, 200);
        return view('backend.pages.certificate.family.bn_certificate', $data);
        $html = view('backend.pages.certificate.family.certificate', $data)->render();
        $pdf = PDF::loadHTML($html)->setPaper('a4', 'landscape')
        ->setOptions([
            'defaultFont' => 'sans-serif',
