...
class TradeLicenseController extends Controller
{
    ...
    public function invoice($id)
    {
        $data['license'] = TradeLicense::with([
            ...
            'organization',
            'organization.type',
            'organization.pendingTransfer.toInstitute.union',
            'organization.pendingTransfer.toInstitute.pourashava',
            'organization.pendingTransfer.toInstitute.cityCorporation',
