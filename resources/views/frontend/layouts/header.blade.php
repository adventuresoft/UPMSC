    ...
    <div class="gov-main-header">
        <div class="container-fluid container mx-auto px-5 max-w-[1200px]">
            <div class="d-flex flex align-items-center items-center justify-content-between justify-between">
                ...
                {{-- Judiciary / Local Govt Right Logo --}}
                <div class="gov-brand-right d-none d-md-flex items-center justify-end">
                    <a href="{{ route('public.village-court.create') }}" class="gov-village-court-btn flex flex-col items-center justify-center text-center group bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-lg px-3 py-1 transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer text-decoration-none">
                        <i class="fas fa-balance-scale text-[#8b5cf6] text-[20px] mb-0.5 group-hover:scale-110 transition-transform"></i>
                        <span class="text-[#6d28d9] font-bold text-[12px] font-bn leading-tight" style="font-family: 'Hind Siliguri', sans-serif;">গ্রাম আদালত</span>
                        <span class="text-purple-600 text-[10px] font-bn tracking-wider mt-0.5" style="font-family: 'Hind Siliguri', sans-serif; opacity: 0.9; font-weight: 600;">মামলা</span>
                    </a>
                </div>
