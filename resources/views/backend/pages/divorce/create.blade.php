@extends('backend.master', ['mainMenu' => 'Marriage', 'subMenu' =>'DivorceCreate'])
...
<style>
    ...
    @media print {
        ...
        .gov-main-header {
            ...
            color: black !important;
            border-bottom: 3px double #7f1d1d !important;
    ...
    <div class="container-fluid">
        <div class="card gov-outer-card">
            ...
            <div class="gov-main-header d-flex justify-content-between align-items-center">
                <div>
                    <h3><i class="fas fa-file-signature mr-2"></i> বিবাহবিচ্ছেদ নিবন্ধন ফর্ম (Divorce Registration Form)</h3>
                    <p>গণপ্রজাতন্ত্রী বাংলাদেশ সরকারের বিবাহ ও তালাক আইন অনুযায়ী আইনানুগ বিবাহবিচ্ছেদ নিবন্ধন ফরম</p>
                </div>
                <div class="d-none d-md-block text-right">
                    <span class="badge badge-light p-2 font-weight-bold" style="border: 1px solid #ef4444;"><i class="fas fa-gavel text-danger"></i> Official Legal Doc</span>
                </div>
            </div>

            <form id="divorceRegistrationForm" action="{{ route('divorce.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="registration_no" class="form-control gov-input" required placeholder="যেমন: DR-2026-0001">
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="divorce_date" class="form-control gov-input" required>
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="divorce_place" class="form-control gov-input" required placeholder="যেমন: বাড্ডা, ঢাকা বা কাজী অফিস">
                            </div>
                            <div class="col-md-4 mb-3">
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row align-items-center mb-4 p-3 style-box" style="background: #f8fafc; border-radius: 10px; border: 1.5px solid #e2e8f0; margin: 0 1px 20px 1px;">
                            <div class="col-md-8 mb-2 mb-md-0">
                                ...
                                <input type="text" id="husband_search_id" class="form-control gov-input font-weight-bold" placeholder="স্বামীর আইডি টাইপ করুন, যেমন: 51-830228-0002" style="background-color: #ffffff; border-color: #cbd5e1;">
                                <input type="hidden" name="husband_user_id" id="husband_user_id">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="husband_name" id="husband_name" class="form-control gov-input" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">পিতার নাম (Father Name)</label>
                                <input type="text" name="husband_father_name" id="husband_father_name" class="form-control gov-input">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">মাতার নাম (Mother Name)</label>
                                <input type="text" name="husband_mother_name" id="husband_mother_name" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">জন্ম তারিখ (Date of Birth)</label>
                                <input type="date" name="husband_dob" id="husband_dob" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">বয়স (Age)</label>
                                <input type="number" name="husband_age" id="husband_age" class="form-control gov-input" min="21">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">এনআইডি/জন্ম সনদ নং (NID/Birth Cert) <span class="text-danger">*</span></label>
                                <input type="text" name="husband_nid" id="husband_nid" class="form-control gov-input" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">ধর্ম (Religion)</label>
                                <input type="text" name="husband_religion" id="husband_religion" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">পেশা (Occupation)</label>
                                <input type="text" name="husband_occupation" id="husband_occupation" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">মোবাইল নম্বর (Mobile Number)</label>
                                <input type="text" name="husband_mobile" id="husband_mobile" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="husband_marital_status" id="husband_marital_status" class="form-control gov-input" style="padding: 5px 12px;">
                                    ...
                                    <option value="Divorced" selected>তালাকপ্রাপ্ত (Divorced)</option>
                                    <option value="Widower">বিপত্নীক (Widower)</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">বর্তমান ঠিকানা (Present Address)</label>
                                <textarea name="husband_present_address" id="husband_present_address" class="form-control gov-input" rows="2"></textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">স্থায়ী ঠিকানা (Permanent Address)</label>
                                <textarea name="husband_permanent_address" id="husband_permanent_address" class="form-control gov-input" rows="2"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row align-items-center mb-4 p-3 style-box" style="background: #fff5f5; border-radius: 10px; border: 1.5px solid #fed7d7; margin: 0 1px 20px 1px;">
                            <div class="col-md-8 mb-2 mb-md-0">
                                ...
                                <input type="text" id="wife_search_id" class="form-control gov-input font-weight-bold" placeholder="স্ত্রীর আইডি টাইপ করুন, যেমন: 51-830228-0003" style="background-color: #ffffff; border-color: #feb2b2;">
                                <input type="hidden" name="wife_user_id" id="wife_user_id">
                            </div>
                            <div class="col-md-4 d-flex justify-content-around align-items-center">
                                <div>
                                    <div class="gov-photo-wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">পূর্ণ নাম (Full Name) <span class="text-danger">*</span></label>
                                <input type="text" name="wife_name" id="wife_name" class="form-control gov-input" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">পিতার নাম (Father Name)</label>
                                <input type="text" name="wife_father_name" id="wife_father_name" class="form-control gov-input">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">মাতার নাম (Mother Name)</label>
                                <input type="text" name="wife_mother_name" id="wife_mother_name" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">জন্ম তারিখ (Date of Birth)</label>
                                <input type="date" name="wife_dob" id="wife_dob" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">বয়স (Age)</label>
                                <input type="number" name="wife_age" id="wife_age" class="form-control gov-input" min="18">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">এনআইডি/জন্ম সনদ নং (NID/Birth Cert) <span class="text-danger">*</span></label>
                                <input type="text" name="wife_nid" id="wife_nid" class="form-control gov-input" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">ধর্ম (Religion)</label>
                                <input type="text" name="wife_religion" id="wife_religion" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">পেশা (Occupation)</label>
                                <input type="text" name="wife_occupation" id="wife_occupation" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">মোবাইল নম্বর (Mobile Number)</label>
                                <input type="text" name="wife_mobile" id="wife_mobile" class="form-control gov-input">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">বৈবাহিক অবস্থা (Marital Status)</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">বর্তমান ঠিকানা (Present Address)</label>
                                <textarea name="wife_present_address" id="wife_present_address" class="form-control gov-input" rows="2"></textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">স্থায়ী ঠিকানা (Permanent Address)</label>
                                <textarea name="wife_permanent_address" id="wife_permanent_address" class="form-control gov-input" rows="2"></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="religion_Islam" class="religion-sub-card" style="border-top: 4px solid #dc2626; background: #fdfdfd;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="islam_wife_wakil_name" class="form-control gov-input">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">স্বামীর উকিল (Husband Wakil Name)</label>
                                    <input type="text" name="islam_husband_wakil_name" class="form-control gov-input">
                                </div>
                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="islam_divorce_reason" class="form-control gov-input" rows="2" placeholder="বিবাহবিচ্ছেদের সংক্ষিপ্ত কারণ বা রেফারেন্স উল্লেখ করুন"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="religion_Hindu" class="religion-sub-card" style="border-top: 4px solid #ea580c;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="hindu_wife_gotra" class="form-control gov-input">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="gov-label">স্বামীর গোত্র (Husband Gotra)</label>
                                    <input type="text" name="hindu_husband_gotra" class="form-control gov-input">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_husband_nid" name="uploaded_documents[]" value="Husband NID" data-target="file_husband_nid">
                                        <label class="custom-control-label font-weight-bold" for="chk_husband_nid">স্বামীর এনআইডি কপি</label>
                                    </div>
                                    <div id="file_husband_nid" class="doc-file-input" style="display: none;">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_wife_nid" name="uploaded_documents[]" value="Wife NID" data-target="file_wife_nid">
                                        <label class="custom-control-label font-weight-bold" for="chk_wife_nid">স্ত্রীর এনআইডি কপি</label>
                                    </div>
                                    <div id="file_wife_nid" class="doc-file-input" style="display: none;">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_divorce_paper" name="uploaded_documents[]" value="Divorce Paper scan" data-target="file_divorce_paper">
                                        <label class="custom-control-label font-weight-bold" for="chk_divorce_paper">তালাকনামা/আদালত রায় স্ক্যান</label>
                                    </div>
                                    <div id="file_divorce_paper" class="doc-file-input" style="display: none;">
                    ...
                    <div class="action-buttons-wrap text-center mt-4">
                        ...
                        <button type="submit" class="btn btn-gov btn-gov-success"><i class="fas fa-save"></i> বিবাহবিচ্ছেদ সম্পন্ন করুন (Submit)</button>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function clearHusbandFields() {
            $('#husband_search_status').hide();
            $('#husband_user_id').val('');
            $('#husband_name').val('');
            $('#husband_father_name').val('');
            $('#husband_mother_name').val('');
            $('#husband_dob').val('');
            $('#husband_age').val('');
            $('#husband_nid').val('');
            $('#husband_religion').val('');
            $('#husband_occupation').val('');
            $('#husband_mobile').val('');
            $('#husband_present_address').val('');
            $('#husband_permanent_address').val('');
            $('#husband_photo_preview').hide().attr('src', '');
        }

        function clearWifeFields() {
            $('#wife_search_status').hide();
            $('#wife_user_id').val('');
            $('#wife_name').val('');
            $('#wife_father_name').val('');
            $('#wife_mother_name').val('');
            $('#wife_dob').val('');
            $('#wife_age').val('');
            $('#wife_nid').val('');
            $('#wife_religion').val('');
            $('#wife_occupation').val('');
            $('#wife_mobile').val('');
            $('#wife_present_address').val('');
            $('#wife_permanent_address').val('');
            $('#wife_photo_preview').hide().attr('src', '');
        }
        ...
        $("#divorceRegistrationForm").on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    submitBtn.prop("disabled", false).html('<i class="fas fa-save"></i> বিবাহবিচ্ছেদ সম্পন্ন করুন (Submit)');
