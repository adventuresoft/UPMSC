                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label for="left_image">Union Logo (Left Side) <span class="text-danger" title="Required"
                                                ...
                                                <img class="img-fluid img-thumbnail my-3" height="120" width="120"
                                                    src="{{ $institute->left_image ? imageUrl($institute->left_image) : asset('default.png') }}" id="left_image_preview"
