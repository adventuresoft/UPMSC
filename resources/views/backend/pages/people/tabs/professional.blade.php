                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-4">
                                        <button type="button" id="addNewProfession" title="Add More"
                                            class="btn btn-primary btn-block shadow-sm" style="background-color: #4f46e5; border-color: #4f46e5;">
                                            <i class="fas fa-plus-circle mr-1"></i> Add Previous Profession
                                        </button>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-0">
                                    <div class="col-sm-4">
                                        <a href="{{ route('people.education', $user->id) }}"
                                            ...
                                            <i class="fas fa-arrow-left mr-1"></i> Education
                                        </a>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <a href="{{ route('people.financial', $user->id) }}"
                                            ...
                                            Financial <i class="fas fa-arrow-right ml-1"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
