                    ...
                    <div class="card shadow-sm border-0">
                        ...
                        <form class="form-horizontal" id="peopleFinancialForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-footer bg-white border-top-0 mt-4">
                                <div class="row mb-3">
                                    <div class="col-sm-4">
                                        <button type="button" id="addNewFinancial" title="Add More" class="btn btn-primary btn-block shadow-sm" style="background-color: #4f46e5; border-color: #4f46e5;">
                                            <i class="fas fa-plus-circle mr-1"></i> Add New More
                                        </button>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-0">
                                    <div class="col-sm-4">
                                        <a href="{{route('people.professional', $user->id)}}" class="btn btn-outline-secondary btn-block">
                                            <i class="fas fa-arrow-left mr-1"></i> Profession
                                        </a>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <a href="{{route('people.property',$user->id)}}" class="btn btn-outline-primary btn-block">
                                            Property <i class="fas fa-arrow-right ml-1"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
