            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card shadow-sm border-0">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="councilorJulyFighterForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-footer bg-white border-top-0 mt-4">
                                <div class="form-group row align-items-center mb-0">
                                    <div class="col-sm-4">
                                        <a href="{{ route('councilor.freedom', $user->id) }}" class="btn btn-outline-secondary btn-block">
                                    ...
                                    <div class="col-sm-4">
                                        <button type="submit" class="btn btn-primary btn-block shadow-sm" style="background-color: #4f46e5; border-color: #4f46e5;">
                                            <i class="fas fa-check-circle mr-1"></i> Save & Continue
                                        </button>
                                    </div>
                                </div>
                            </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            $("#councilorJulyFighterForm").on('submit', function(e) {
                e.preventDefault();
                let thisForm = $(this);
                $.ajax({
                    type: "POST",
                    url: "{{ route('councilor.julyFighterStore') }}",
