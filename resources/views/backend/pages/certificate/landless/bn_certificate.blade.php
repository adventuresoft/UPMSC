                ...
                <div class="row mt-5">
                    <div class="col-12" style="font-size:18px; line-height:1.9; text-align:justify;">
                        <p>
                            ...
                            রাস্তা - <span>{{ optional($certificate->user->addressInfo)->mother_name_bn ?? '' }}</span>,
                            বাড়ি নং - <span>{{ optional($certificate->user->addressInfo)->permanent_house_bn ?? '' }}</span>,
                            ...
                            আমার জানা মতে তিনি আইন-শৃঙ্খলা ও রাষ্ট্র বিরোধী কোন অপরাধের সাথে জড়িত নন।
                        </p>
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('landless.index') }}";
    }
</script>
@endpush