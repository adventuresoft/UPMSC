                ...
                <div class="row mt-3 align-items-center">
                    ...
                    <div class="col-md-4 text-center">
                        <span class="badge bg-info text-light px-4 py-2"
                            ...
                            জাতীয় পরিচয়পত্রের সংশোধনের সনদ
                        </span>
                    </div>
...
@if(data_get($certificate, 'user.addressInfo.permanentPostOffice.postal_code'))
    {{ bnValue(data_get($certificate, 'user.addressInfo.permanentPostOffice.postal_code')) }},
@endif
    ...
    <div class="text-center mt-2 mb-4">
        <button id="cancelPageButton" class="btn btn-danger btn-sm px-4"
                onclick="window.location.href='{{ route('nid-correction.index') }}'">
            Cancel
        </button>
