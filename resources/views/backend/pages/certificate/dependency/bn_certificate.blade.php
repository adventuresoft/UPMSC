...
@endif
                            ...
                            তিনি তার পরিবারের অন্যান্য সদস্য বা নির্দিষ্ট ব্যক্তির উপর সম্পূর্ণরূপে নির্ভরশীল।
    ...
    <div class="text-center mt-2 mb-4 d-print-none">
        <button id="cancelPageButton" class="btn btn-danger btn-sm px-4"
                onclick="window.location.href='{{ route('dependency.index') }}'">
            Cancel
        </button>
