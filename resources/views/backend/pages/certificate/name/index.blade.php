                ...
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h3 class="card-title" style="font-size:24px; font-weight: semi-bold;">Name Certificate</h3>
                            </div>
                                  ...
                                  @endif <br>
                                   ...
                                   {{ $certificate->user?->institute?->union?->thana?->district?->bn_name ?? '' }}।
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank"
                                            href="{{ route('name.show', $certificate->id) }}"
                                            class="btn btn-primary btn-sm">
                                            <i class="fa fa-file-pdf"></i> EN
                                        </a>

                                        <a target="_blank"
                                            href="{{ route('name.bn_certificate', $certificate->id) }}"
