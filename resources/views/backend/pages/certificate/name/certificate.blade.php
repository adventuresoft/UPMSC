                ...
                <div class="row mt-5">
                    <div class="col-12" style="font-size:18px; line-height:1.9; text-align:justify;">
                        <p>
                            ...
                            <strong>{{ !empty($certificate->user->people->name) ? $certificate->user->people->name : ($certificate->user->name ?? '') }}</strong> 
                            alias <strong>{{ $certificate->name_english }}</strong>,
...
@endif
                           ...
                           He/She is a Bangladeshi citizen by birth and a permanent resident of this union.
The different names mentioned refer to the same identical person. It is certified that {{ !empty($certificate->user->people->name) ? $certificate->user->people->name : ($certificate->user->name ?? '') }} alias {{ $certificate->name_english }} is the same person. To my knowledge, he/she is of good character and has not been involved in any crime against law and order or the state.
                        </p>
