...
@endif
                           ...
                           He/She is granted permission to construct infrastructure on his/her own property within this union.
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('infrastructure-construction-permission.index') }}";
    }
</script>
@endpush
