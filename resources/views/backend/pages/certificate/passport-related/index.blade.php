@extends('backend.master', ['mainMenu' => 'Certificate', 'subMenu' =>'PassportRelated'])
...
@section('title', 'PassportRelated Certificate')
                ...
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h3 class="card-title" style="font-size:24px; font-weight: semi-bold;">PassportRelated Certificate</h3>
                            </div>

                            <div class="col-md-6 text-right">
                                @if (create_permission('certificate'))
                                <a href="{{ route('passport-related.create') }}" class="btn btn-primary">Create</a>
                                <a href="{{ route('passport-related.index') }}" class="btn btn-primary">List</a>
                                @endif
                            </div>
                        </div>
                    </div>
                                  ...
                                  @endif <br>
                                   ...
                                   {{ $certificate->user?->institute?->union?->thana?->district?->bn_name ?? '' }}।
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank"
                                            href="{{ route('passport-related.show', $certificate->id) }}"
                                            class="btn btn-primary btn-sm">
                                            <i class="fa fa-file-pdf"></i> EN
                                        </a>

                                        <a target="_blank"
                                            href="{{ route('passport-related.bn_certificate', $certificate->id) }}"
