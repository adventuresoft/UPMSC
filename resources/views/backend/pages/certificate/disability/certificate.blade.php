...
He/She is a specially-abled (disabled) person. To my knowledge, he is of good character and has not been involved in any crime against law and order or the state.
                        </p>
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('disability-certificate.index') }}";
    }
</script>
@endpush
