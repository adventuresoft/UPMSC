...
@endif
                            ...
                            তিনি তার সম্পত্তি বা আইনি অধিকার অন্য কাউকে অর্পণের ক্ষমতা প্রদান করেছেন।
    ...
    <div class="text-center mt-2 mb-4 d-print-none">
        <button id="cancelPageButton" class="btn btn-danger btn-sm px-4"
                onclick="window.location.href='{{ route('power-of-attorney.index') }}'">
            Cancel
        </button>
