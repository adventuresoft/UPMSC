...
@endif
                           ...
                           He/She has granted the power of attorney to transfer his/her property or legal rights to someone else.
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('power-of-attorney.index') }}";
    }
</script>
@endpush
