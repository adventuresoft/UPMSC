...
<body>
    <div class="container">
                                        ...
                                        <td colspan="3">
                                            <p>This is to certify that <strong
                                                ...
                                                Id no.: <strong class="text-danger">
                                                    {{ $certificate->user->people->approved_id ?? '' }}</strong>
                                                son of <strong
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3" class="text-right">
                                            ...
                                            <p>Chairman</p>
                                            <p>{{ $certificate->user->institute->union->name ?? '' }}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
        ...
        <footer class="card-footer">
            <p>This report generated by UPMS | Powered by <strong>Adventure Soft</strong></p>
        </footer>
    </div>
