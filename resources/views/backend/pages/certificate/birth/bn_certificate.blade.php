                ...
                <div class="row mt-3 align-items-center">
                    ...
                    <div class="col-6 text-center" style="white-space: nowrap;">
                        <span class="badge  text-light px-4 py-2"
                              style="font-size: clamp(14px, 1.5vw, 22px); white-space: nowrap; border-radius:28px; background-color: #2F318C;; background-color: #2F318C;">">
                            জন্ম সনদপত্র
                        </span>
                    </div>
...
@endif
                            ...
                            তার জন্ম নিবন্ধন অত্র কার্যালয়ে সঠিকভাবে তালিকাভুক্ত রয়েছে। আমার জানা মতে তিনি আইন-শৃঙ্খলা ও রাষ্ট্রবিরোধী কোন কার্যকলাপের সাথে জড়িত নন।
                        </p>
