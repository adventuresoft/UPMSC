...
He/She is known as a residential inhabitant of this area. To my knowledge, he is of good character and has not been involved in any crime against law and order or the state.
                        </p>
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('residential.index') }}";
    }
</script>
@endpush
