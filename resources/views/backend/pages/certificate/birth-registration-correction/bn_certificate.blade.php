...
@endif
                            ...
                            তার জন্ম নিবন্ধনে ভুল থাকায় তা সংশোধনের জন্য সুপারিশ করা হলো।
    ...
    <div class="text-center mt-2 mb-4 d-print-none">
        <button id="cancelPageButton" class="btn btn-danger btn-sm px-4"
                onclick="window.location.href='{{ route('birth-registration-correction.index') }}'">
            Cancel
        </button>
