@extends('backend.master', ['mainMenu' => 'Certificate', 'subMenu' =>'Tribal'])
...
@section('title', 'Tribal Certificate')
                ...
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h3 class="card-title" style="font-size:24px; font-weight: semi-bold;">Tribal Certificate</h3>
                            </div>

                            <div class="col-md-6 text-right">
                                @if (create_permission())
                                <a href="{{ route('tribal.create') }}" class="btn btn-primary">Create</a>
                                <a href="{{ route('tribal.index') }}" class="btn btn-primary">List</a>
                                @endif
                            </div>
                        </div>
                    </div>
                                  ...
                                  @endif <br>
                                   ...
                                   {{ $certificate->user?->institute?->union?->thana?->district?->bn_name ?? '' }}।
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank"
                                            href="{{ route('tribal.show', $certificate->id) }}"
                                            class="btn btn-primary btn-sm">
                                            <i class="fa fa-file-pdf"></i> EN
                                        </a>

                                        <a target="_blank"
                                            href="{{ route('tribal.bn_certificate', $certificate->id) }}"
