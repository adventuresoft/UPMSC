...
@section('content')
   ...
   <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Helplessness Certificate</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('helplessness.index')}}">Helplessness Certificate</a></li>
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" id="certificateForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-footer">
                                <div class="form-group row">
                                    <a href="{{route('helplessness.index')}}" class="btn btn-default float-right">Cancel</a>
                                    <div class="col-sm-9">
