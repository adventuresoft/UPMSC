...
He/She is an orphan and his/her parents are no longer alive. To my knowledge, he is of good character and has not been involved in any crime against law and order or the state.
                        </p>
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('orphan.index') }}";
    }
</script>
@endpush
