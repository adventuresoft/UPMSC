...
@section('title', 'GuardianIncome Certificate')
...
The annual income of his/her guardian is certified to be true. To my knowledge, he is of good character and has not been involved in any crime against law and order or the state.
                        </p>
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('guardian-income.index') }}";
    }
</script>
@endpush
