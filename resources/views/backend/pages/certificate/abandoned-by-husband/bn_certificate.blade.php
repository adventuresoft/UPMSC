                ...
                <div class="row mt-3 align-items-center">
                    ...
                    <div class="col-6 text-center" style="white-space: nowrap;">
                        <span class="badge  text-light px-4 py-2"
                            ...
                            স্বামী পরিত্যক্তা প্রত্যয়ন পত্র
                        </span>
                    </div>
...
@endif
                            ...
                            তিনি তার স্বামী কর্তৃক পরিত্যক্তা এবং বর্তমানে একাকী বা নিজ পরিবারে বসবাস করছেন।
    ...
    <div class="text-center mt-2 mb-4 d-print-none">
        <button id="cancelPageButton" class="btn btn-danger btn-sm px-4"
                onclick="window.location.href='{{ route('abandoned-by-husband.index') }}'">
            Cancel
        </button>
