                ...
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h3 class="card-title" style="font-size:24px; font-weight: semi-bold;">Financial Instability Certificate</h3>
                            </div>

                            <div class="col-md-6 text-right">
                                @if (create_permission('certificate'))
                                <a href="{{ route('financial-instability.create') }}" class="btn btn-primary">Create</a>
                                <a href="{{ route('financial-instability.index') }}" class="btn btn-primary">List</a>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3 align-items-center g-2">
                            ...
                            <!-- Income Range Filter -->
                            <div class="col-md-2">
                                <input type="text" id="search_income_range" class="form-control form-control-sm"
                            ...
                            <tbody>
                                @if ($certificates && count($certificates) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a target="_blank"
                                                href="{{ route('financial-instability.show', $certificate->id) }}"
                                                class="btn btn-primary btn-sm">
                                                <i class="fa fa-file-pdf"></i> EN
                                            </a>

                                            <a target="_blank"
                                                href="{{ route('financial-instability.bn_certificate', $certificate->id) }}"
                                ...
                                @else
                                    <tr>
                                        <td colspan="100%" class="empty-state">
                                            ...
                                            @if (create_permission('certificate'))
                                            <a href="{{ route('financial-instability.create') }}" class="btn btn-primary mt-2">
...
<script>
    $(function() {
        ...
        // Income Range (Column 5)
        $('#search_income_range').keyup(function() {
