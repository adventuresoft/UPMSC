...
@section('title', 'FinancialInstability Certificate')
                ...
                <div class="row mt-3 align-items-center">
                    ...
                    <div class="col-6 text-center" style="white-space: nowrap;">
                        <span class="badge text-light px-4 py-2" style="font-size: clamp(12px, 1.5vw, 20px); white-space: nowrap; border-radius:28px; background-color: #2F318C;">
                            Certificate of Financial Insolvency
                        </span>
                    </div>
...
He/She is financially insolvent and living below the poverty line. To my knowledge, he is of good character and has not been involved in any crime against law and order or the state.
                        </p>
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('financial-instability.index') }}";
    }
</script>
@endpush
