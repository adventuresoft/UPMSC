               ...
               <!-- ================= Header ================= -->
                ...
                <div class="row mt-3 align-items-center">
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        আর্থিক অস্বচ্ছলতার প্রত্যায়নপত্র
                        </span>
                    </div>
...
@endif
                            ...
                            তিনি আর্থিকভাবে অত্যন্ত অস্বচ্ছল এবং দারিদ্র্যসীমার নিচে বসবাস করছেন। আমার জানা মতে তিনি আইন-শৃঙ্খলা ও রাষ্ট্রবিরোধী কোন কার্যকলাপের সাথে জড়িত নন।
                        </p>
...
<!-- ================= Footer ================= -->
    ...
    <div class="text-center mt-2 mb-4 d-print-none">
        <button id="cancelPageButton" class="btn btn-danger btn-sm px-4"
                onclick="window.location.href='{{ route('financial-instability.index') }}'">
            Cancel
        </button>
