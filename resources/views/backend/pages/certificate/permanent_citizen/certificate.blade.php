...
@section('title', 'PermanentCitizen Certificate')
...
He/She is a permanent citizen of this area by generation. To my knowledge, he is of good character and has not been involved in any crime against law and order or the state.
                        </p>
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('permanent-citizen.index') }}";
    }
</script>
@endpush
