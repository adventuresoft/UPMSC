...
@endif
                            ...
                            কৃষিকাজে সেচযন্ত্র ব্যবহারের সুবিধার্থে তাকে জ্বালানি তেল কার্ড প্রদানের সুপারিশ করা হলো।
    ...
    <div class="text-center mt-2 mb-4 d-print-none">
        <button id="cancelPageButton" class="btn btn-danger btn-sm px-4"
                onclick="window.location.href='{{ route('farmer-fuel-oil-card.index') }}'">
            Cancel
        </button>
