...
@endif
                           ...
                           He/She is recommended for a fuel oil card to facilitate the use of irrigation equipment in agriculture.
...
<script>
    function goToIndex(){
        ...
        window.location.href = "{{ route('farmer-fuel-oil-card.index') }}";
    }
</script>
@endpush
