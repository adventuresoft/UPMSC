            ...
            <div class="inner-frame">
                ...
                <div class="row mt-3 align-items-center">
                    ...
                    <div class="col-6 text-center" style="white-space: nowrap;">
                        <span class="badge text-light px-4 py-2" style="font-size: clamp(14px, 1.5vw, 22px); white-space: nowrap; border-radius:28px; background-color: #2F318C;; background-color: #2F318C;">
                            চারিত্রিক সনদপত্র
                        </span>
                    </div>
