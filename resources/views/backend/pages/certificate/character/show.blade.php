                ...
                <div class="border border-5 border-info p-5">
                    ...
                    <div class="row">
                        <div class="col-md-2 text-right">
                            <img height="100" width="100" class="mx-auto d-block"
                                src=" {{isset($certificate->user->institute->left_image) ? url('/' . $certificate->user->institute->left_image)  : asset('assets/images/logo/govt-bd-logo.png')}}"
                                alt="govt-bd-logo">
                        </div>
                        ...
                        <div class="col-md-2 text-left">
                            <img height="100" width="100" class="mx-auto d-block"
                                src="{{isset($certificate->user->institute->right_image) ? url('/' . $certificate->user->institute->right_image)  : 'https://upload.wikimedia.org/wikipedia/en/thumb/a/ab/Mujib_100_Logo.svg/1200px-Mujib_100_Logo.svg.png'}} "
                                alt="govt-bd-logo">
                        </div>
                    </div>
