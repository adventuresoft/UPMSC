    ...
    <div class="container-fluid">
        <div class="card gov-outer-card">
            ...
            <div class="gov-main-header d-flex justify-content-between align-items-center">
                <div>
                    <h3><i class="fas fa-edit mr-2"></i> বিবাহ নিবন্ধন তথ্য সংশোধন (Marriage Registration Edit Form)</h3>
                    <p>নিবন্ধিত তথ্যাদি আইনানুগ সংশোধন ও হালনাগাদ করার আবেদন ফর্ম</p>
                </div>
                <div class="d-none d-md-block text-right">
                    <span class="badge badge-light p-2 font-weight-bold" style="border: 1px solid #3b82f6;"><i class="fas fa-edit text-primary"></i> Edit Mode</span>
                </div>
            </div>

            <form id="marriageRegistrationForm" action="{{ route('marriage.update', $marriage->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="registration_no" class="form-control gov-input" required value="{{ $marriage->registration_no }}" placeholder="যেমন: MR-2026-0001">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="marriage_type" id="marriageTypeSelect" class="form-control gov-input" required style="padding: 5px 12px;">
                                    ...
                                    <option value="Islam" {{ $marriage->marriage_type == 'Islam' ? 'selected' : '' }}>ইসলাম (Islam)</option>
                                    <option value="Hindu" {{ $marriage->marriage_type == 'Hindu' ? 'selected' : '' }}>হিন্দু (Hindu)</option>
                                    <option value="Christian" {{ $marriage->marriage_type == 'Christian' ? 'selected' : '' }}>খ্রিস্টান (Christian)</option>
                                    <option value="Other" {{ $marriage->marriage_type == 'Other' ? 'selected' : '' }}>অন্যান্য (Other)</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">বিবাহের তারিখ (Marriage Date) <span class="text-danger">*</span></label>
                                <input type="date" name="marriage_date" class="form-control gov-input" required value="{{ $marriage->marriage_date }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">নিবন্ধনের তারিখ (Registration Date) <span class="text-danger">*</span></label>
                                <input type="date" name="registration_date" class="form-control gov-input" required value="{{ $marriage->registration_date }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">বিবাহের স্থান (Marriage Place) <span class="text-danger">*</span></label>
                                <input type="text" name="marriage_place" class="form-control gov-input" required value="{{ $marriage->marriage_place }}" placeholder="যেমন: কমিউনিটি সেন্টার বা কনের বাড়ি">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="marriage_area_type" class="form-control gov-input" style="padding: 5px 12px;">
                                    <option value="Union Parishad" {{ $marriage->marriage_area_type == 'Union Parishad' ? 'selected' : '' }}>ইউনিয়ন পরিষদ (Union Parishad)</option>
                                    <option value="Municipality" {{ $marriage->marriage_area_type == 'Municipality' ? 'selected' : '' }}>পৌরসভা (Municipality)</option>
                                    <option value="City Corporation" {{ $marriage->marriage_area_type == 'City Corporation' ? 'selected' : '' }}>সিটি কর্পোরেশন (City Corporation)</option>
                                </select>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select id="division_id" name="division_id" class="form-control gov-input select2">
                                    ...
                                    @foreach($divisions as $division)
                                        <option value="{{ $division->id }}" {{ $marriage->division_id == $division->id ? 'selected' : '' }}>{{ $division->bn_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select id="district_id" name="district_id" class="form-control gov-input select2">
                                    ...
                                    @foreach($districts as $district)
                                        <option value="{{ $district->id }}" {{ $marriage->district_id == $district->id ? 'selected' : '' }}>{{ $district->bn_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select id="upazila_id" name="upazila_id" class="form-control gov-input select2">
                                    ...
                                    @foreach($upazilas as $upazila)
                                        <option value="{{ $upazila->id }}" {{ $marriage->upazila_id == $upazila->id ? 'selected' : '' }}>{{ $upazila->bn_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select id="union_id" name="union_id" class="form-control gov-input select2">
                                    ...
                                    @foreach($unions as $union)
                                        <option value="{{ $union->id }}" {{ $marriage->union_id == $union->id ? 'selected' : '' }}>{{ $union->bn_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">ওয়ার্ড নং (Ward No)</label>
                                <input type="text" name="ward_no" class="form-control gov-input" value="{{ $marriage->ward_no }}" placeholder="যেমন: ০৩">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">গ্রাম/মহল্লা (Village/Area)</label>
                                <input type="text" name="village_area" class="form-control gov-input" value="{{ $marriage->village_area }}" placeholder="যেমন: পূর্বপাড়া">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">ডাকঘর (Post Office)</label>
                                <input type="text" name="post_office" class="form-control gov-input" value="{{ $marriage->post_office }}" placeholder="যেমন: সদর ডাকঘর">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">পোস্ট কোড (Post Code)</label>
                                <input type="text" name="post_code" class="form-control gov-input" value="{{ $marriage->post_code }}" placeholder="যেমন: ১২৩০">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row align-items-center mb-4 p-3 style-box" style="background: #f8fafc; border-radius: 10px; border: 1.5px solid #e2e8f0; margin: 0 1px 20px 1px;">
                            <div class="col-md-8 mb-2 mb-md-0">
                                ...
                                <input type="text" id="groom_search_id" class="form-control gov-input font-weight-bold" value="{{ $marriage->groomUser?->system_id }}" placeholder="বরের আইডি টাইপ করুন, যেমন: 51-830228-0002" style="background-color: #ffffff; border-color: #cbd5e1;">
                                <input type="hidden" name="groom_user_id" id="groom_user_id" value="{{ $marriage->groom_user_id }}">
                            </div>
                            <div class="col-md-4 d-flex justify-content-around align-items-center">
                                <div>
                                    <div class="gov-photo-wrapper">
                                        ...
                                        <img id="groom_photo_preview" src="{{ $marriage->groom_photo ? imageUrl($marriage->groom_photo) : '' }}" style="{{ $marriage->groom_photo ? 'display: block;' : 'display: none;' }}">
                                    </div>
                                </div>
                                <div>
                                    <div class="gov-photo-wrapper">
                                        ...
                                        <img id="groom_sig_preview" src="{{ $marriage->groom_signature ? imageUrl($marriage->groom_signature) : '' }}" style="{{ $marriage->groom_signature ? 'display: block;' : 'display: none;' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="groom_name" id="groom_name" class="form-control gov-input" required value="{{ $marriage->groom_name }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">পিতার নাম (Father Name)</label>
                                <input type="text" name="groom_father_name" id="groom_father_name" class="form-control gov-input" value="{{ $marriage->groom_father_name }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">মাতার নাম (Mother Name)</label>
                                <input type="text" name="groom_mother_name" id="groom_mother_name" class="form-control gov-input" value="{{ $marriage->groom_mother_name }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">জন্ম তারিখ (Date of Birth)</label>
                                <input type="date" name="groom_dob" id="groom_dob" class="form-control gov-input" value="{{ $marriage->groom_dob }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">বয়স (Age)</label>
                                <input type="number" name="groom_age" id="groom_age" class="form-control gov-input" min="21" value="{{ $marriage->groom_age }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">এনআইডি/জন্ম সনদ নং (NID/Birth Cert) <span class="text-danger">*</span></label>
                                <input type="text" name="groom_nid" id="groom_nid" class="form-control gov-input" required value="{{ $marriage->groom_nid }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">ধর্ম (Religion)</label>
                                <input type="text" name="groom_religion" id="groom_religion" class="form-control gov-input" value="{{ $marriage->groom_religion }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">পেশা (Occupation)</label>
                                <input type="text" name="groom_occupation" id="groom_occupation" class="form-control gov-input" value="{{ $marriage->groom_occupation }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">মোবাইল নম্বর (Mobile Number)</label>
                                <input type="text" name="groom_mobile" id="groom_mobile" class="form-control gov-input" value="{{ $marriage->groom_mobile }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="groom_marital_status" id="groom_marital_status" class="form-control gov-input" style="padding: 5px 12px;">
                                    <option value="Unmarried" {{ $marriage->groom_marital_status == 'Unmarried' ? 'selected' : '' }}>অবিবাহিত (Unmarried)</option>
                                    <option value="Married" {{ $marriage->groom_marital_status == 'Married' ? 'selected' : '' }}>বিবাহিত (Married)</option>
                                    <option value="Divorced" {{ $marriage->groom_marital_status == 'Divorced' ? 'selected' : '' }}>তালাকপ্রাপ্ত (Divorced)</option>
                                    <option value="Widower" {{ $marriage->groom_marital_status == 'Widower' ? 'selected' : '' }}>বিপত্নীক (Widower)</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">বর্তমান ঠিকানা (Present Address)</label>
                                <textarea name="groom_present_address" id="groom_present_address" class="form-control gov-input" rows="2">{{ $marriage->groom_present_address }}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">স্থায়ী ঠিকানা (Permanent Address)</label>
                                <textarea name="groom_permanent_address" id="groom_permanent_address" class="form-control gov-input" rows="2">{{ $marriage->groom_permanent_address }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row align-items-center mb-4 p-3 style-box" style="background: #fff5f5; border-radius: 10px; border: 1.5px solid #fed7d7; margin: 0 1px 20px 1px;">
                            <div class="col-md-8 mb-2 mb-md-0">
                                ...
                                <input type="text" id="bride_search_id" class="form-control gov-input font-weight-bold" value="{{ $marriage->brideUser?->system_id }}" placeholder="কনের আইডি টাইপ করুন, যেমন: 51-830228-0003" style="background-color: #ffffff; border-color: #feb2b2;">
                                <input type="hidden" name="bride_user_id" id="bride_user_id" value="{{ $marriage->bride_user_id }}">
                            </div>
                            <div class="col-md-4 d-flex justify-content-around align-items-center">
                                <div>
                                    <div class="gov-photo-wrapper">
                                        ...
                                        <img id="bride_photo_preview" src="{{ $marriage->bride_photo ? imageUrl($marriage->bride_photo) : '' }}" style="{{ $marriage->bride_photo ? 'display: block;' : 'display: none;' }}">
                                    </div>
                                </div>
                                <div>
                                    <div class="gov-photo-wrapper">
                                        ...
                                        <img id="bride_sig_preview" src="{{ $marriage->bride_signature ? imageUrl($marriage->bride_signature) : '' }}" style="{{ $marriage->bride_signature ? 'display: block;' : 'display: none;' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">পূর্ণ নাম (Full Name) <span class="text-danger">*</span></label>
                                <input type="text" name="bride_name" id="bride_name" class="form-control gov-input" required value="{{ $marriage->bride_name }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">পিতার নাম (Father Name)</label>
                                <input type="text" name="bride_father_name" id="bride_father_name" class="form-control gov-input" value="{{ $marriage->bride_father_name }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">মাতার নাম (Mother Name)</label>
                                <input type="text" name="bride_mother_name" id="bride_mother_name" class="form-control gov-input" value="{{ $marriage->bride_mother_name }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">জন্ম তারিখ (Date of Birth)</label>
                                <input type="date" name="bride_dob" id="bride_dob" class="form-control gov-input" value="{{ $marriage->bride_dob }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">বয়স (Age)</label>
                                <input type="number" name="bride_age" id="bride_age" class="form-control gov-input" min="18" value="{{ $marriage->bride_age }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">এনআইডি/জন্ম সনদ নং (NID/Birth Cert) <span class="text-danger">*</span></label>
                                <input type="text" name="bride_nid" id="bride_nid" class="form-control gov-input" required value="{{ $marriage->bride_nid }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">ধর্ম (Religion)</label>
                                <input type="text" name="bride_religion" id="bride_religion" class="form-control gov-input" value="{{ $marriage->bride_religion }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">পেশা (Occupation)</label>
                                <input type="text" name="bride_occupation" id="bride_occupation" class="form-control gov-input" value="{{ $marriage->bride_occupation }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">মোবাইল নম্বর (Mobile Number)</label>
                                <input type="text" name="bride_mobile" id="bride_mobile" class="form-control gov-input" value="{{ $marriage->bride_mobile }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="gov-label">বৈবাহিক অবস্থা (Marital Status)</label>
                                <select name="bride_marital_status" id="bride_marital_status" class="form-control gov-input" style="padding: 5px 12px;">
                                    <option value="Unmarried" {{ $marriage->bride_marital_status == 'Unmarried' ? 'selected' : '' }}>অবিবাহিত (Unmarried)</option>
                                    <option value="Divorced" {{ $marriage->bride_marital_status == 'Divorced' ? 'selected' : '' }}>তালাকপ্রাপ্ত (Divorced)</option>
                                    <option value="Widow" {{ $marriage->bride_marital_status == 'Widow' ? 'selected' : '' }}>বিধবা (Widow)</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">বর্তমান ঠিকানা (Present Address)</label>
                                <textarea name="bride_present_address" id="bride_present_address" class="form-control gov-input" rows="2">{{ $marriage->bride_present_address }}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="gov-label">স্থায়ী ঠিকানা (Permanent Address)</label>
                                <textarea name="bride_permanent_address" id="bride_permanent_address" class="form-control gov-input" rows="2">{{ $marriage->bride_permanent_address }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 border-md-right pr-md-4">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="witness_1_name" id="witness_1_name" class="form-control gov-input" value="{{ $marriage->witness_1_name }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="gov-label">এনআইডি নম্বর (NID Number)</label>
                                    <input type="text" name="witness_1_nid" id="witness_1_nid" class="form-control gov-input" value="{{ $marriage->witness_1_nid }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="gov-label">মোবাইল নম্বর (Mobile Number)</label>
                                    <input type="text" name="witness_1_mobile" id="witness_1_mobile" class="form-control gov-input" value="{{ $marriage->witness_1_mobile }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="gov-label">ঠিকানা (Address)</label>
                                    <input type="text" name="witness_1_address" id="witness_1_address" class="form-control gov-input" value="{{ $marriage->witness_1_address }}">
                                </div>
                                <div class="form-group mb-2">
                                    ...
                                    @if($marriage->witness_1_signature)
                                        <div class="mt-2">
                                            <img src="{{ imageUrl($marriage->witness_1_signature) }}" height="50" style="border: 1px solid #ccc; border-radius: 4px; padding: 2px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 pl-md-4 mt-4 mt-md-0">
                                ...
                                <div class="form-group mb-2">
                                    <label class="gov-label">পূর্ণ নাম (Full Name)</label>
                                    <input type="text" name="witness_2_name" id="witness_2_name" class="form-control gov-input" value="{{ $marriage->witness_2_name }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="gov-label">এনআইডি নম্বর (NID Number)</label>
                                    <input type="text" name="witness_2_nid" id="witness_2_nid" class="form-control gov-input" value="{{ $marriage->witness_2_nid }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="gov-label">মোবাইল নম্বর (Mobile Number)</label>
                                    <input type="text" name="witness_2_mobile" id="witness_2_mobile" class="form-control gov-input" value="{{ $marriage->witness_2_mobile }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="gov-label">ঠিকানা (Address)</label>
                                    <input type="text" name="witness_2_address" id="witness_2_address" class="form-control gov-input" value="{{ $marriage->witness_2_address }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label class="gov-label">সাক্ষীর স্বাক্ষর (Signature Upload)</label>
                                    ...
                                    @if($marriage->witness_2_signature)
                                        <div class="mt-2">
                                            <img src="{{ imageUrl($marriage->witness_2_signature) }}" height="50" style="border: 1px solid #ccc; border-radius: 4px; padding: 2px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div id="religion_Islam" class="religion-sub-card" style="border-top: 4px solid #16a34a; background: #fdfdfd;">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="islam_kabin_number" class="form-control gov-input" value="{{ $marriage->islam_kabin_number }}" placeholder="যেমন: KB-1002">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">দেনমোহরের পরিমাণ (Den Mohor Amount)</label>
                                    <input type="text" name="islam_den_mohor_amount" class="form-control gov-input" value="{{ $marriage->islam_den_mohor_amount }}" placeholder="যেমন: ৫,০০,০০০">
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="islam_den_mohor_type" class="form-control gov-input" style="padding: 5px 12px;">
                                        <option value="Prompt" {{ $marriage->islam_den_mohor_type == 'Prompt' ? 'selected' : '' }}>নগদ পরিশোধিত (Prompt/Nogod)</option>
                                        <option value="Deferred" {{ $marriage->islam_den_mohor_type == 'Deferred' ? 'selected' : '' }}>বাকি/ধার্যকৃত (Deferred/Baki)</option>
                                        <option value="Both" {{ $marriage->islam_den_mohor_type == 'Both' ? 'selected' : '' }}>উভয়ই (Both)</option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">কনের উকিল (Bride Wakil Name)</label>
                                    <input type="text" name="islam_bride_wakil_name" class="form-control gov-input" value="{{ $marriage->islam_bride_wakil_name }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">বরের উকিল (Groom Wakil Name)</label>
                                    <input type="text" name="islam_groom_wakil_name" class="form-control gov-input" value="{{ $marriage->islam_groom_wakil_name }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">নিবন্ধনকারী কাজী (Kazi Name)</label>
                                    <input type="text" name="islam_kazi_name" class="form-control gov-input" value="{{ $marriage->islam_kazi_name }}" placeholder="যেমন: আলহাজ্ব কাজী আব্দুর রহমান">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">কাজী লাইসেন্স নম্বর (Kazi License No)</label>
                                    <input type="text" name="islam_kazi_license_no" class="form-control gov-input" value="{{ $marriage->islam_kazi_license_no }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="religion_Hindu" class="religion-sub-card" style="border-top: 4px solid #ea580c;">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="hindu_temple_name" class="form-control gov-input" value="{{ $marriage->hindu_temple_name }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">পুরোহিতের নাম (Purohit Name)</label>
                                    <input type="text" name="hindu_purohit_name" class="form-control gov-input" value="{{ $marriage->hindu_purohit_name }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">ধর্মীয় অনুষ্ঠানের তারিখ (Ritual Date)</label>
                                    <input type="date" name="hindu_marriage_ritual_date" class="form-control gov-input" value="{{ $marriage->hindu_marriage_ritual_date }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="gov-label">কনের গোত্র (Bride Gotra)</label>
                                    <input type="text" name="hindu_bride_gotra" class="form-control gov-input" value="{{ $marriage->hindu_bride_gotra }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="gov-label">বরের গোত্র (Groom Gotra)</label>
                                    <input type="text" name="hindu_groom_gotra" class="form-control gov-input" value="{{ $marriage->hindu_groom_gotra }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="hindu_saptapadi_completed" class="form-control gov-input" style="padding: 5px 12px;">
                                        <option value="Yes" {{ $marriage->hindu_saptapadi_completed == 'Yes' ? 'selected' : '' }}>হ্যাঁ (Yes)</option>
                                        <option value="No" {{ $marriage->hindu_saptapadi_completed == 'No' ? 'selected' : '' }}>না (No)</option>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="hindu_sacred_fire_ceremony" class="form-control gov-input" style="padding: 5px 12px;">
                                        <option value="Yes" {{ $marriage->hindu_sacred_fire_ceremony == 'Yes' ? 'selected' : '' }}>হ্যাঁ (Yes)</option>
                                        <option value="No" {{ $marriage->hindu_sacred_fire_ceremony == 'No' ? 'selected' : '' }}>না (No)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="religion_Christian" class="religion-sub-card" style="border-top: 4px solid #2563eb;">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="christian_church_name" class="form-control gov-input" value="{{ $marriage->christian_church_name }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">পাস্টরের নাম (Pastor Name)</label>
                                    <input type="text" name="christian_pastor_name" class="form-control gov-input" value="{{ $marriage->christian_pastor_name }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">লাইসেন্স নম্বর (License No)</label>
                                    <input type="text" name="christian_marriage_license_no" class="form-control gov-input" value="{{ $marriage->christian_marriage_license_no }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="gov-label">বিবাহের বিজ্ঞপ্তি প্রকাশকাল (Publication of Banns)</label>
                                    <input type="text" name="christian_publication_of_banns" class="form-control gov-input" value="{{ $marriage->christian_publication_of_banns }}" placeholder="যেমন: ৩ সপ্তাহ পূর্বে">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="gov-label">পরিচালনাকারীর নাম (Marriage Conducted By)</label>
                                    <input type="text" name="christian_marriage_conducted_by" class="form-control gov-input" value="{{ $marriage->christian_marriage_conducted_by }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="religion_Other" class="religion-sub-card" style="border-top: 4px solid #db2777;">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="other_religion_name" class="form-control gov-input" value="{{ $marriage->other_religion_name }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">ধর্মীয় নেতার নাম (Religious Leader Name)</label>
                                    <input type="text" name="other_religious_leader_name" class="form-control gov-input" value="{{ $marriage->other_religious_leader_name }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="gov-label">অনুষ্ঠানের ধরণ (Ceremony Type)</label>
                                    <input type="text" name="other_ceremony_type" class="form-control gov-input" value="{{ $marriage->other_ceremony_type }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="gov-label">প্রতিষ্ঠান/উপাসনালয়ের নাম (Organization/Temple Name)</label>
                                    <input type="text" name="other_organization_name" class="form-control gov-input" value="{{ $marriage->other_organization_name }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="gov-label">অন্যান্য বিবরণ (Other Details)</label>
                                    <textarea name="other_other_details" class="form-control gov-input" rows="2">{{ $marriage->other_other_details }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_groom_nid" name="uploaded_documents[]" value="Groom NID" data-target="file_groom_nid" {{ $marriage->doc_groom_nid ? 'checked' : '' }}>
                                        <label class="custom-control-label font-weight-bold" for="chk_groom_nid">বরের এনআইডি কপি</label>
                                    </div>
                                    <div id="file_groom_nid" class="doc-file-input" style="{{ $marriage->doc_groom_nid ? 'display: block;' : 'display: none;' }}">
                                        <input type="file" name="doc_groom_nid_file" class="form-control gov-input" style="padding: 5px;">
                                        @if($marriage->doc_groom_nid)
                                            <div class="mt-1"><a href="{{ imageUrl($marriage->doc_groom_nid) }}" target="_blank" class="small text-primary"><i class="fas fa-file"></i> View Current Doc</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_bride_nid" name="uploaded_documents[]" value="Bride NID" data-target="file_bride_nid" {{ $marriage->doc_bride_nid ? 'checked' : '' }}>
                                        <label class="custom-control-label font-weight-bold" for="chk_bride_nid">কনের এনআইডি কপি</label>
                                    </div>
                                    <div id="file_bride_nid" class="doc-file-input" style="{{ $marriage->doc_bride_nid ? 'display: block;' : 'display: none;' }}">
                                        <input type="file" name="doc_bride_nid_file" class="form-control gov-input" style="padding: 5px;">
                                        @if($marriage->doc_bride_nid)
                                            <div class="mt-1"><a href="{{ imageUrl($marriage->doc_bride_nid) }}" target="_blank" class="small text-primary"><i class="fas fa-file"></i> View Current Doc</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_birth_certificate" name="uploaded_documents[]" value="Birth Certificate" data-target="file_birth_certificate" {{ $marriage->doc_birth_certificate ? 'checked' : '' }}>
                                        <label class="custom-control-label font-weight-bold" for="chk_birth_certificate">জন্ম নিবন্ধন সনদ কপি</label>
                                    </div>
                                    <div id="file_birth_certificate" class="doc-file-input" style="{{ $marriage->doc_birth_certificate ? 'display: block;' : 'display: none;' }}">
                                        ...
                                        @if($marriage->doc_birth_certificate)
                                            <div class="mt-1"><a href="{{ imageUrl($marriage->doc_birth_certificate) }}" target="_blank" class="small text-primary"><i class="fas fa-file"></i> View Current Doc</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_passport_photo" name="uploaded_documents[]" value="Passport Photo" data-target="file_passport_photo" {{ $marriage->doc_passport_photo ? 'checked' : '' }}>
                                        <label class="custom-control-label font-weight-bold" for="chk_passport_photo">পাসপোর্ট সাইজ ফটো কপি</label>
                                    </div>
                                    <div id="file_passport_photo" class="doc-file-input" style="{{ $marriage->doc_passport_photo ? 'display: block;' : 'display: none;' }}">
                                        <input type="file" name="doc_passport_photo_file" class="form-control gov-input" style="padding: 5px;">
                                        @if($marriage->doc_passport_photo)
                                            <div class="mt-1"><a href="{{ imageUrl($marriage->doc_passport_photo) }}" target="_blank" class="small text-primary"><i class="fas fa-file"></i> View Current Doc</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_witness_nid" name="uploaded_documents[]" value="Witness NID" data-target="file_witness_nid" {{ $marriage->doc_witness_nid ? 'checked' : '' }}>
                                        <label class="custom-control-label font-weight-bold" for="chk_witness_nid">সাক্ষীর এনআইডি কপি</label>
                                    </div>
                                    <div id="file_witness_nid" class="doc-file-input" style="{{ $marriage->doc_witness_nid ? 'display: block;' : 'display: none;' }}">
                                        <input type="file" name="doc_witness_nid_file" class="form-control gov-input" style="padding: 5px;">
                                        @if($marriage->doc_witness_nid)
                                            <div class="mt-1"><a href="{{ imageUrl($marriage->doc_witness_nid) }}" target="_blank" class="small text-primary"><i class="fas fa-file"></i> View Current Doc</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_marriage_certificate" name="uploaded_documents[]" value="Marriage Certificate Scan" data-target="file_marriage_certificate" {{ $marriage->doc_marriage_certificate_scan ? 'checked' : '' }}>
                                        <label class="custom-control-label font-weight-bold" for="chk_marriage_certificate">আদালত/কাজী সনদ স্ক্যান</label>
                                    </div>
                                    <div id="file_marriage_certificate" class="doc-file-input" style="{{ $marriage->doc_marriage_certificate_scan ? 'display: block;' : 'display: none;' }}">
                                        ...
                                        @if($marriage->doc_marriage_certificate_scan)
                                            <div class="mt-1"><a href="{{ imageUrl($marriage->doc_marriage_certificate_scan) }}" target="_blank" class="small text-primary"><i class="fas fa-file"></i> View Current Doc</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="doc-checkbox-card">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input doc-checkbox" id="chk_other" name="uploaded_documents[]" value="Other" data-target="file_other" {{ $marriage->doc_other ? 'checked' : '' }}>
                                        <label class="custom-control-label font-weight-bold" for="chk_other">অন্যান্য প্রমাণপত্র (যদি থাকে)</label>
                                    </div>
                                    <div id="file_other" class="doc-file-input" style="{{ $marriage->doc_other ? 'display: block;' : 'display: none;' }}">
                                        <input type="file" name="doc_other_file" class="form-control gov-input" style="padding: 5px;">
                                        @if($marriage->doc_other)
                                            <div class="mt-1"><a href="{{ imageUrl($marriage->doc_other) }}" target="_blank" class="small text-primary"><i class="fas fa-file"></i> View Current Doc</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="gov-section">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="registrar_name" class="form-control gov-input" value="{{ $marriage->registrar_name }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="gov-label">লাইসেন্স নম্বর (License Number)</label>
                                <input type="text" name="registrar_license" class="form-control gov-input" value="{{ $marriage->registrar_license }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                @if($marriage->registrar_office_seal)
                                    <div class="mt-2">
                                        <img src="{{ imageUrl($marriage->registrar_office_seal) }}" height="50" style="border: 1px solid #ccc; border-radius: 4px; padding: 2px;">
                                    </div>
                                @endif
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="gov-label">অফিসিয়াল ঠিকানা (Office Address)</label>
                                <input type="text" name="registrar_office_address" class="form-control gov-input" value="{{ $marriage->registrar_office_address }}" placeholder="যেমন: বাড্ডা কাজী অফিস, ঢাকা">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="mb-2">
                                    ...
                                    @if($marriage->registrar_signature)
                                        <div class="mt-2">
                                            <img src="{{ imageUrl($marriage->registrar_signature) }}" height="50" style="border: 1px solid #ccc; border-radius: 4px; padding: 2px;">
                                        </div>
                                    @endif
                                </div>
                                <div style="border-top: 1.5px dashed #475569; width: 80%; margin: 0 auto; padding-top: 8px;">
                    ...
                    <div class="action-buttons-wrap text-center mt-4">
                        <a href="{{ route('marriage.index') }}" class="btn btn-gov btn-gov-secondary"><i class="fas fa-arrow-left"></i> তালিকা (Back to List)</a>
...
<script>
    $(document).ready(function() {
        ...
        let initialRel = "{{ $marriage->marriage_type }}";
        if(initialRel) {
        ...
        function registerPhotoPreview(inputEl, previewEl) {
            $(inputEl).on('change', function() {
                if (this.files && this.files[0]) {
                    ...
                    // Do not hide existing preview images, just keep them if files reset
                }
            });
        }
        ...
        $('#groom_search_id').on('keyup input', function() {
            ...
            if (groomId.length > 5) {
                ...
                // Keep current values in edit mode unless explicitly searched
            }
        });
