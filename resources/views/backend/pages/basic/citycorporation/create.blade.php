...
@push('style')
@endpush
@section('title', 'City Corporation Create')
@section('content')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">City Corporation Create Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="cityCorporationForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="City Corporation Name in English" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="bn_name" name="bn_name" placeholder="City Corporation Name in Bengali">
...
<script>
    $(document).ready(function() {
        ...
        $("#cityCorporationForm").on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('basic-settings.city-corporation.store')}}",
