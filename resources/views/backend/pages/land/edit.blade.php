            ...
            <form class="form-horizontal" id="landEditForm" method="POST" action="{{ route('land.update', $land->id) }}" enctype="multipart/form-data">
                ...
                <div class="card-body p-4"> 
                            ...
                            <table class="premium-table" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="records[{{$key}}][mouza]" class="premium-input" value="{{ $rec['mouza'] ?? '' }}" placeholder="মৌজার নাম" required></td>
                                        <td><input type="text" name="records[{{$key}}][dag_no]" class="premium-input text-center" value="{{ $rec['dag_no'] ?? '' }}" placeholder="দাগ নং" required></td>
                                        <td><input type="text" name="records[{{$key}}][khatian_no]" class="premium-input text-center" value="{{ $rec['khatian_no'] ?? '' }}" placeholder="খতিয়ান নং" required></td>
                                        <td>
                                        ...
                                        <td><input type="text" name="records[{{$key}}][total_land_dag]" class="premium-input text-center" value="{{ $rec['total_land_dag'] ?? '' }}" placeholder="০.০০" required></td>
                                        <td><input type="text" name="records[{{$key}}][land_amount]" class="premium-input text-center" value="{{ $rec['land_amount'] ?? '' }}" placeholder="০.০০" required></td>
                                        <td><input type="text" name="records[{{$key}}][owner_name]" class="premium-input" value="{{ $rec['owner_name'] ?? '' }}" placeholder="মালিকের নাম" required></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <div id="step-2" style="display: none;">
                        ...
                        @php $ownerUser = $land->owner_user; @endphp
                        <div id="ownerDetails" class="alert mt-4 p-4 shadow-sm" style="display: block; background: #ffffff; border-left: 5px solid #10b981; border-radius: 8px; border-top: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0;">
                            <strong>Name:</strong> {{ $ownerUser->name ?? ($ownerUser->people->bn_name ?? 'N/A') }} <br>
                            <strong>Phone:</strong> {{ $ownerUser->mobile ?? 'N/A' }} <br>
                            <strong>NID/Birth Cert:</strong> {{ $ownerUser->nid ?? ($ownerUser->birth_certificate ?? 'N/A') }}
                        </div>
